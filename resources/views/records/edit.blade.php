...
@section('content')
	...
	<div class="row">
		...
		<h2 class="text-center" style="color:#DEBF45">Modifíca Grabación</h2>
		<hr>

			{!!Form::model($record, ['route' => ['admin.grabaciones.update', $record->id], 'method' => 'PUT', 'data-parsley-validate' => '', 'files' => true])!!}
